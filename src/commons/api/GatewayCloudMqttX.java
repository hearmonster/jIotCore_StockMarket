...
public class GatewayCloudMqttX
implements GatewayCloud {
	...
	//public GatewayCloudMqttX(Device device, SSLSocketFactory sslSocketFactory) {  <<Original
	public GatewayCloudMqttX( String deviceAltId, SSLSocketFactory sslSocketFactory ) {
		String deviceAlternateId = deviceAltId;
		String clientId = deviceAltId;
