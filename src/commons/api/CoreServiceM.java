...
public class CoreServiceM {

	private HttpClient httpClient;

	private String baseUri;

	public CoreServiceM(String host, SSLSocketFactory sslSocketFactory) {
		baseUri = String.format("https://%1$s/iot/core/api/v1", host);
		httpClient = new HttpClient( sslSocketFactory );
	}

	public CoreServiceM(String host, String instance, String tenant, String user, String password) {
		baseUri = String.format("https://%1$s/iot/core/api/v1", host);
	...
	public AuthenticationX getAuthentication(Device device)
	throws IOException {
